...
export default function MinimalSkeleton() {
	return (
		<div className="p-4 mb-5 bg-gray-800 animate-pulse rounded-l border-gray-300 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700">
