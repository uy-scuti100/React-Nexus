			...
			<div className="flex items-center justify-between gap-10">
				<div className="flex flex-col gap-3">
					<div className="flex items-center gap-2">
						<div className="w-8 h-8 bg-gray-200 rounded-full dark:dark:bg-gray-600"></div>
						<div className="w-8 h-3 bg-gray-200 rounded-full dark:bg-gray-600"></div>
						<div className="w-10 h-3 bg-gray-200 rounded-full dark:bg-gray-600"></div>
					</div>
					<div className="w-32 h-3 mb-2 bg-gray-200 rounded-full dark:bg-gray-600"></div>
				...
				<div className="flex flex-col items-end gap-3">
					<div>
						<div className="w-20 h-16 bg-gray-200 rounded-lg dark:bg-gray-600"></div>
					</div>
					<div className="flex items-center gap-2">
