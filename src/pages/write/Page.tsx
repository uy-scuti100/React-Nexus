													...
													>
														...
														{postImage instanceof File ? (
															<span className="mb-5 text-xs text-center">
																Click the image Icon above to change article
																image
															</span>
														) : (
															<span className="mb-5 text-xs text-center">
																Select a captivating cover image for your
																article. This image will be the visual
																centerpiece of your article, grabbing readers'
																attention and setting the tone for your content.
															</span>
														)}
													</label>
													<input
								...
								render={({ field }) => (
									<FormItem className="flex flex-col gap-4">
										...
										<div className="flex items-start gap-2 pb-5 md:items-center opacity-80">
											<p className="text-xs ">
												Choose a compelling title for your article. This is what
												readers will see first and sets the stage for your
												article's content
											</p>
										</div>
								...
								render={({ field }) => (
									<FormItem className="flex flex-col gap-4">
										...
										<div className="pb-5 text-xs opacity-80">
											Please provide a short and captivating snippet . This will
											appear right next to your article's title and cover image,
											giving readers a glimpse of what your article is about
										</div>
										<FormMessage />
									</FormItem>
								)}
