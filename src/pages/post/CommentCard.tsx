		...
		<>
					...
					<div key={comment?.id} className="flex items-start gap-3 pb-4">
						...
						<div className="flex flex-col flex-1 ">
							<div className="flex items-center justify-between mb-1">
								<p className="font-semibold">{comment?.comment_author_name}</p>
							...
							{isEditing ? (
								<div className="flex flex-col gap-2">
									...
									<div className="flex items-center justify-end ">
										<button
											...
											className="px-5 py-2 mt-5 mr-3 font-semibold text-black rounded-full bg-accent-red hover:bg-yellow-500 dark:text-black"
										>
											Revert
										</button>
										<button
											onClick={handleSaveClick}
											className="px-5 py-2 mt-5 font-semibold text-black rounded-full bg-accent-red hover:bg-yellow-500 dark:text-black"
										>
											Save
										</button>
									</div>
								...
								<p className="p-2 rounded-md bg-input">{comment?.content}</p>
							)}
						</div>
					</div>
					...
					<form onSubmit={user ? handleReplySubmit : goHome}>
						<div className="pl-8 mt-4">
							...
							<div className="flex justify-end">
								<button
									type="button"
									className="px-5 py-2 mt-5 mr-3 font-semibold rounded-full bg-accent-red hover:bg-opacity-50 text-wh-10 dark:text-black"
								...
								<button
									type="submit"
									className="px-5 py-2 mt-5 font-semibold rounded-full bg-accent-red hover:bg-opacity-50 text-wh-10 dark:text-black"
								>
									Post Reply
								</button>
							</div>
			...
			{replies?.length > 0 && (
				<>
					...
					{areChildrenHidden && (
						<button
							className="px-5 py-2 my-5 font-semibold text-black bg-accent-red hover:bg-yellow-500 dark:text-black"
